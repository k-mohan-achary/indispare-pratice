        ...
        <div>
          ...
          <Row gutter={[16, 16]}>
            <Col md={{span:4}}>
                ...
                >  
                    <div className='sell-product'>  
                        <img src={'https://indisparedev.s3.ap-south-1.amazonaws.com/product/141506/1.jpg'} />  
                        <h2>India Bearing & Mills Stores</h2>  
                    </div> 
                </Card> 
            </Col>
            <Col md={{span:4}}>Coloumn</Col>
            <Col md={{span:4}}>Coloumn</Col>
            <Col md={{span:4}}>Coloumn</Col> 
          </Row>
